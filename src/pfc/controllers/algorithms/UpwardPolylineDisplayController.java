/**
 * UpwardPolylineDisplayController.java
 * 24/07/2011 02:56:44
 */
...
import pfc.models.algorithms.polyline.UpwardPolylineAlgorithm;
...
public class UpwardPolylineDisplayController extends JPanel implements ExecutionControlPanelActions
{		
	/**
	 ...
	 */
	private UpwardPolylineAlgorithm							algorithm;
	 ...
	 * @param graph Graph
	 */
	public UpwardPolylineDisplayController( Graph graph )
	{				
		this.algorithm = new UpwardPolylineAlgorithm( new Graph( graph.toString( ) ) );
		this.algorithm.addObserver( new Observer( )
		{
			@Override
			public void update(Observable o, Object arg)
			{
				UpwardPolylineDisplayController.this.onAlgorithmChanged( arg );
			}
		} );
		...
		{
			{
				...
				title.setTitle( StringBundle.get( "upward_polyline_graph_title" ) );
