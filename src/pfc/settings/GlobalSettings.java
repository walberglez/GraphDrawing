...
{
	public static final String		applicationAuthor						= "Walber González Sedeño";
	public static final String		applicationDescription					= "Aplicación desarrollada en Java que ejecuta algoritmos de visualización de grafos paso a paso";
	public static final String		applicationName							= "Visibility Representations | Step-By-Step";
	public static final String		applicationVersion						= "1.0";
	public static final String		applicationWebsite						= "http://www.dma.fi.upm.es/gregorio/grafos/paginagrafos.html";
	...
	public static final double		defaultEdgeHandleClickMargin			= 3.5;
	...
	public static final int			defaultEdgeWeightPrecision				= 0;
	public static final Color[ ]	defaultElementColors					= new Color[ ] { Color.getHSBColor( 0, .75f, .95f ), Color.getHSBColor( 1 / 12f, .75f, .95f ), Color.getHSBColor( 1 / 6f, .75f, .95f ), Color.getHSBColor( 2 / 6f, .75f, .95f ), Color.getHSBColor( 3 / 6f, .75f, .95f ), Color.getHSBColor( 4 / 6f, .75f, .95f ), Color.getHSBColor( 5 / 6f, .75f, .95f ), Color.LIGHT_GRAY };
	...
	public static final Color		defaultSelectedVertexFill				= Color.blue;
	...
	public static final Color		defaultUncoloredDualEdgeLine			= new Color( 125, 125, 0 );
	public static final Color		defaultUncoloredVertexFill				= Color.green;
	public static final Color		defaultUncoloredDualVertexFill			= Color.red;
	...
	public static final Color		defaultVertexLabelColor					= Color.black;
	...
	public static final int			defaultVertexWeightPrecision			= 0;
	...
	/* Nuevas configuraciones globales */
	public static final Color		defaultDesktopPaneColor					= Color.LIGHT_GRAY;
	public static final double		defaultVertexSegmentOffset				= 10.0;
	public static final double		defaultHorizontalCoordinateGap			= 40.0;
	public static final double		defaultVerticalCoordinateGap			= 60.0;
	public static final double		defaultCoordinateAxesGap				= 20.0;
